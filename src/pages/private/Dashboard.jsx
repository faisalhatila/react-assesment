...
//       } min-h-screen mt-[192px] text-white`}
//     >
...
//             <div
//               key={index}
//               className="cursor-pointer relative overflow-hidden bg-darkprimary border border-1 border-border text-center rounded-xl transition-colors hover:bg-[#121111]"
//               style={{ aspectRatio: '1 / 1' }}
//               onClick={() => console.log({ item1: item })}
//             >
...
//             <div
//               key={index}
//               className="cursor-pointer relative overflow-hidden border border-1 border-secondary text-center rounded-xl transition-colors text-transparent"
//               style={{ aspectRatio: '1 / 1' }}
